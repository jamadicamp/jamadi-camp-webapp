...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between px-4 md:px-20 py-4 bg-white">
      {/* LOGO */}
      ...
      <div className="flex md:hidden flex-col gap-1 cursor-pointer" onClick={toggleSidebar}>
        {/* Top line */}
        <motion.span
