    ...
    <div className="font-[family-name:var(--font-geist-sans)]">
      ...
      <div className="relative w-full h-screen">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <p className="text-gray-200 max-w-xl mb-8">
            Escape the city and immerse yourself in nature. Experience fresh air,
            cozy fires, and unforgettable moments in our scenic hideaway.
          </p>
          <a
            href="#highlights"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-500">
              Gather around the fire pit for stories, marshmallows, and star-filled nights.
            </p>
          </div>
          {/* Highlight 2 */}
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-500">
              Wake up to panoramic mountain vistas, perfect for nature photography.
            </p>
          </div>
          {/* Highlight 3 */}
          <div className="flex flex-col items-center">
      ...
      <section className="relative bg-black text-white py-12 md:py-16 px-4 md:px-20 text-center">
        ...
        <p className="text-gray-300 max-w-2xl mx-auto mb-8">
          Don&apos;t miss the chance to recharge in our tranquil cabins.
          Reserve your spot now and experience Jamadi at its best.
        </p>
